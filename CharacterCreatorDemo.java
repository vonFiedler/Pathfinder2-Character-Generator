// Name: Ryan von Fiedler
// Date: 10/16/20
// Program: Character creator for Pathfinder
...
public class CharacterCreatorDemo {
...
//      }
      ...
      PrintWriter charSheet = new PrintWriter(fileName);
      charSheet.println("Name: " + firstName + " " + lastName);
      charSheet.println("Ancestry: " + ancestry);
      charSheet.println("Class: " + jobClass);
      charSheet.println("Background: " + background);
      charSheet.println("Alignment: " + alignmentF);
      charSheet.print("Abilities: " + (bigStat[1][0] * 2 + 10) + " STR, ");
      charSheet.print((bigStat[1][1] * 2 + 10) + " DEX, ");
      charSheet.print((bigStat[1][2] * 2 + 10) + " CON, ");
      charSheet.print((bigStat[1][3] * 2 + 10) + " INT, ");
      charSheet.print((bigStat[1][4] * 2 + 10) + " WIS, ");
      charSheet.print((bigStat[1][5] * 2 + 10) + " CHA");
      
      charSheet.close();
      
      // Reads character sheet for user convenience
      File sheet = new File(fileName);
      Scanner sheetReader = new Scanner(sheet);
      
      while(sheetReader.hasNext()) {
         String sheetLine = sheetReader.nextLine();
         System.out.println(sheetLine);
      }
